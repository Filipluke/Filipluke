...
I work on engineering and research-oriented projects combining **mechanical, electrical and software systems**.  
...
**Languages & tools:**  
`Python` `Bash` `SQL` `LaTeX`  

**Libraries & frameworks:**  
`DynPy` `SymPy` `NumPy` `Matplotlib`  

**Systems & hardware:**  
`Raspberry Pi` `Linux` `Networking` `Docker`  

**Other:**  
`Git` `CI/CD` `Technical documentation`
...
⭐ If you find my projects useful, feel free to star or contribute!
